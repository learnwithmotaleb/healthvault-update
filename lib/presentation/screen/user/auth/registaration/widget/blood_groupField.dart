...
class BloodGroupField extends StatelessWidget {
  ...
  const BloodGroupField({
    ...
    this.focusNode,
    this.hintText = 'Select your blood group',
    this.validator,
    this.onSelected,
        ...
        return SafeArea(
          child: Column(
            ...
            children: [
              ...
              Text('Select Blood Group', style: AppTextStyles.title),
              const SizedBox(height: 8),
              Flexible(
                child: ListView.separated(
                  shrinkWrap: true,
                  padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                  itemCount: BloodGroups.items.length,
                  separatorBuilder: (_, __) => const Divider(height: 1, color: Color(0xFFE6E6E6)),
                  itemBuilder: (ctx, index) {
                    final item = BloodGroups.items[index];
