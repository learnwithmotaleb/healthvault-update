...
import 'freequency_services.dart';


class FreequencyField extends StatelessWidget {
  ...
  FreequencyField({
    ...
    this.focusNode,
    this.hintText = "Select Frequency",
    this.validator,
    this.onSelected,
        ...
        return SafeArea(
          child: Column(
            ...
            children: [
              ...
              Text("Select Frequency", style: AppTextStyles.title),
              const SizedBox(height: 8),
              Flexible(
                child: ListView.separated(
                  shrinkWrap: true,
                  padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                  itemCount: freequencyServices.items.length,
                  separatorBuilder: (_, __) => const Divider(height: 1, color: Color(0xFFE6E6E6)),
                  itemBuilder: (ctx, index) {
                    final item = freequencyServices.items[index];
