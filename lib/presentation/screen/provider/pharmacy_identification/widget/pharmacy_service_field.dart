...
class PharmacyServiceField extends StatelessWidget {
        ...
        return SafeArea(
          child: Column(
            ...
            children: [
              ...
              Text(AppStrings.selectDosage.tr, style: AppTextStyles.title),
              const SizedBox(height: 8),
              Flexible(
                child: ListView.separated(
                  shrinkWrap: true,
                  padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                  itemCount: PharmacyServices.items.length,
                  separatorBuilder: (_, __) => const Divider(height: 1, color: Color(0xFFE6E6E6)),
                  itemBuilder: (ctx, index) {
                    final item = PharmacyServices.items[index];
