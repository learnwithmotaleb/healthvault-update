class HealthLogSelfModel {
  bool? success;
  String? message;
  int? statusCode;
  List<Data>? data;

  HealthLogSelfModel({this.success, this.message, this.statusCode, this.data});

  factory HealthLogSelfModel.fromJson(Map<String, dynamic> json) {
    return HealthLogSelfModel(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    // Safe conversion for weight (int or double)
