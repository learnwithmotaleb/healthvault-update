...
class SelectYourServiceField extends StatelessWidget {
  ...
  final EdgeInsets contentPadding;
   ...
   SelectYourServiceField({
    ...
    this.focusNode,
    this.hintText = AppStrings.selectYourService,
    this.validator,
    this.onSelected,
        ...
        return SafeArea(
          child: Column(
            ...
            children: [
              ...
              Text(AppStrings.selectYourService.tr, style: AppTextStyles.title),
              const SizedBox(height: 8),
              Flexible(
                child: ListView.separated(
                  shrinkWrap: true,
                  padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                  itemCount: ServiceGroups.items.length,
                  separatorBuilder: (_, __) => const Divider(height: 1, color: Color(0xFFE6E6E6)),
                  itemBuilder: (ctx, index) {
                    final item = ServiceGroups.items[index];
